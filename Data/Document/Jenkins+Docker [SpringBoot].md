...
![img](<../Img/jenkins+Docker \[springboot].png>)
...
[Jenkins 서버 swap메모리 할당](Linux.md)
...
![img](../Img/docker+jenkins1.png)\


> docker pull jenkins/jenkins\
>

![img](../Img/docker+jenkins2.png)\
...
![img](../Img/docker+jenkins3.png)\


![img](../Img/docker+jenkins4.png)\
...
![img](../Img/docker+jenkins10.png)\
(jenkins괸리 -> Tools로 이동)

![img](../Img/docker+jenkins11.png)\
...
![img](../Img/docker+jenkins14.png)\


(플러그인을 설치한뒤 restart를 해도 jenkins가 재실행이 안됨)\


![img](../Img/docker+jenkins15.png)\
...
![img](../Img/docker+jenkins20.png)\


> mkdir -p /etc/apt/keyrings\
>

![img](../Img/docker+jenkins21.png)\
...
![img](../Img/docker+jenkins31.png)\
(서버 배포가 된것을 확인)\


### 최종 테스트

![img](../Img/docker+jenkins32.png)\
(프로젝트를 수정한뒤 Github에 커밋)\


![img](../Img/docker+jenkins33.png)\
